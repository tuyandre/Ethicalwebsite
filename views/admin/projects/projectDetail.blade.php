@extends('shared.master') @section('title','Project Detail') @section('css')
...
@endsection @section('items','Project Detail') @section('content')
			...
			<div class="page-header">
				...
				<div class="d-flex">
					<div class="justify-content-center">
						...
						<button type="button" class="btn btn-primary my-2 btn-icon-text add_project"> <i class="fe fe-download-cloud mr-2"></i> Add Project</button>
					</div>
				</div>
			</div>
			<!-- End Page Header -->
