<html dir="ltr" lang="en" xmlns="http://www.w3.org/1999/html" class="global-potloc-init">
							...
							<fieldset class="MuiFormControl-root jss17">
								...
								<div class="MuiFormControl-root MuiTextField-root jss24">
									...
									<div class="MuiInputBase-root MuiFilledInput-root MuiInputBase-colorSecondary MuiFilledInput-colorSecondary MuiInputBase-formControl">
										<input aria-invalid="false" id="email" name="email" placeholder="email@domain.com" required="" type="email" class="MuiInputBase-input MuiFilledInput-input @error('email') is-invalid @enderror" value="">
                                        @error('email')
