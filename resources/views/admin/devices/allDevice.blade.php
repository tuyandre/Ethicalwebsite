...
<div class="page-header">
	...
	<div class="d-flex">
		<div class="justify-content-center"><a class="btn btn-primary my-2 btn-icon-text" data-target="#addDevice" data-toggle="modal" href="#"><i class="fe fe-plus mr-2"></i>Add New Device</a>
		</div>
	</div>
</div>
<!-- End Page Header -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-content-demo">
			...
			<div class="modal-body">
				...
				<form action="{{route('admin.devices.saveDevices')}}" method="post" data-parsley-validate="" id="frmSave">{{ csrf_field() }}
					<div class="">
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">Device Name:</div>
									</div>
						...
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">Device Brand:</div>
									</div>
									<input class="form-control" id="textMask" name="device_brand" placeholder="Device Brand" type="text" required>
								</div>
							</div>
						</div>
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
									...
									<input class="form-control" name="device_model" required id="mask" placeholder="Device Model" type="text">
								</div>
							</div>
						</div>
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">Devicen S/N:</div>
									</div>
									<input class="form-control" name="device_serialNo" required id="emailMask" placeholder="Device Serial Number" type="text">
								</div>
							</div>
						</div>
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">Device IMEI 1:</div>
									</div>
						...
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">Device IMEI 2:</div>
									</div>
									<input class="form-control" id="imei2" placeholder="IMEI TWO " type="number" name="imei2">
								</div>
							</div>
						</div>
					</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-content-demo">
			...
			<div class="modal-body">
				...
				<form action="{{route('admin.devices.assignDevices')}}" method="post" data-parsley-validate="" id="assignFrmSave">{{ csrf_field() }}
					<div class="">
						<div class="row row-sm form-group">
							<div class="col-lg-12">
								<div class="input-group">
